...
<html lang="en">
    ...
    <body>
            ...
            <div class="container">
                <nav aria-label="breadcrumb">
                    <ol class="fables-breadcrumb breadcrumb px-0 py-3">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Láminas</li>
        ...
        <div class="fables-light-background-color ">
            <div class="container">
                <%if (session.getAttribute("user") != null) {%>
                <a href="laminas-detalladas.jsp" style="color: #ffffff" class="font-18 btn fables-btn-rouned fables-light-gary-background    dropdown-toggle right px-3 px-md-2 px-lg-4  top-header-link  position-relative" >
                    Vista detallada
        ...
        <section class="ftco-section ftco-no-pt ftco-no-pb">
            <div class="container-fluid p-0">
                ...
                <div class="row no-gutters" id="busqueda">
                    ...
                    <%for (Lamina l : LaminaDAO.listarLamina("a")) {%>    
