...
<html lang="en">
    ...
    <body>
        ...
        <div class="fables-footer-image fables-after-overlay white-color py-4 py-lg-5 bg-rules" style="background-image: url(../../imagenes/fondo-ciencias.jpg);">
            <div class="container">
                <h2 class="fables-page-title fables-second-border-color">GUÍA DE PRÁCTICA 16 - MODELOS ATÓMICOS: Modelo atómico del Hidrógeno</h2>
            </div>
        </div>
        <!-- /End Header -->
            ...
            <div class="container">
                <nav aria-label="breadcrumb">
                    <ol class="fables-breadcrumb breadcrumb px-0 py-3">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">MODELOS ATÓMICOS: Modelo atómico del Hidrógeno</li>
                    </ol>
            ...
            <div class="col-12 col-lg-10 offset-lg-1 col-xl-8 offset-xl-2 mt-4 mt-xl-5" >
                ...
                <div class="col-12 col-lg-8">   
                    ...
                    <label class="fables-main-text-color fables-single-blog font-14 my-3" >
                        ...
                        <li>Visualizar los diferentes modelos del átomo de hidrógeno.</li> 
                        <li>Explicar por qué la gente creía en cada modelo y por qué cada modelo histórico es inadecuado.</li> 
                        <li>Explicar la relación entre la imagen física de las órbitas y el diagrama de nivel de energía de un electrón.</li>
                        <li>Participar en la construcción de modelos.</li>
                    </label>
                    <br>
                    ...
                    <ul class="fables-main-text-color  font-14 my-3">
                        ...
                        <li type="square">GUÍA DE PRÁCTICA 16 - MODELOS ATÓMICOS: Modelo atómico del Hidrógeno</li>
                    ...
                    <ol class="fables-main-text-color  font-14 my-3">
                        <li>Seleccionar modo Experimento, aquí el átomo de hidrogeno está oculto detrás de un cuadro negro. Descubrir a qué modelo corresponde el experimento.</li>

                        <li>Seleccionar modo Predicción, aquí se muestran los diferentes modelos. Experimentar con cada uno de ellos e interpretarlos.</li>
                        Notas
                        <ul>
                            <li>*	Use el ícono de la cámara para tomar una instantánea del espectrómetro para que pueda comparar los patrones de diferentes modelos.</li>
                            <li>*	Ajuste el control deslizante en la parte inferior a rápido para construir el patrón del espectrómetro rápidamente</li>
                        </ul>
                    ...
                    <ol class="fables-main-text-color  font-14 my-3" >
                        ...
                        <li>
                            En el modelo de Schrodinger, la probabilidad de una transición se basa en la superposición entre las funciones de onda, y algunas transiciones están prohibidas o son altamente improbables. Por lo tanto, hay menos líneas espectrales en el modelo de Schrodinger que en el modelo de Bohr o de Broglie.
                        </li>
                    ...
                    <p class="fables-main-text-color  font-14 my-3" >
                        Se conoce como modelos atómicos a las distintas representaciones estructurales y funcionamiento de los átomos, desarrolladas a lo largo de la historia de la humanidad, a partir de las ideas que en cada época se manejaban respecto a de qué estaba hecha la materia.  
                    </p>
                    <p class="fables-main-text-color  font-14 my-3" >
                        Modelo atómico de Thomson: planteó el modelo de Pudín de ciruelas, en donde exclamaba que el átomo se considera como una esfera de carga negativa, con los electrones distribuidos en número suficiente para neutralizar la carga positiva.
                    </p>
                    <p>
                        Modelo atómico de Rutherford: descubrió que los electrones giran alrededor del núcleo como los planetas alrededor del sol (modelo planetario).
                    </p>
                    <p class="fables-main-text-color  font-14 my-3">
                        Modelo atómico de Niels Bohr: planteó que el electrón gira alrededor del núcleo en órbitas circulares.
                    </p>
                    <p class="fables-main-text-color  font-14 my-3">
                        Modelo de Schrodinger: establece la presencia de orbitales, que son regiones en el espacio en donde es probable encontrar el electrón. En donde aparecen tres parámetros: n, l, m
                    </p>
                    <p class="fables-main-text-color  font-14 my-3">
                        Modelo de Louis de Broglie: propuso que el electrón tendría propiedades ondulatorias y de partículas al igual que la energía lumínica.
                    </p>
