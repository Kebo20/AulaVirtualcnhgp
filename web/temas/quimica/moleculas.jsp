...
<html lang="en">
    ...
    <body>
        ...
        <div class="fables-footer-image fables-after-overlay white-color py-4 py-lg-5 bg-rules" style="background-image: url(../../imagenes/fondo-ciencias.jpg);">
            <div class="container">
                <h2 class="fables-page-title fables-second-border-color">GUÍA DE PRÁCTICA 15 - MOLÉCULAS: Construir una molécula</h2>
            </div>
        </div>
        <!-- /End Header -->
            ...
            <div class="container">
                <nav aria-label="breadcrumb">
                    <ol class="fables-breadcrumb breadcrumb px-0 py-3">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">MOLÉCULAS: Construir una molécula</li>
                    </ol>
            ...
            <div class="col-12 col-lg-10 offset-lg-1 col-xl-8 offset-xl-2 mt-4 mt-xl-5" >
                ...
                <div class="col-12 col-lg-8">   
                    ...
                    <label class="fables-main-text-color fables-single-blog font-14 my-3" >
                        ...
                        <li>	Describir las diferencias entre un átomo y una molécula.</li> 
                        <li>	Construir moléculas simples con átomos.</li> 
                        <li>	Reconocer que el subíndice en la fórmula molecular indica el número de átomos en la molécula.</li>
                        <li>	Reconocer que el coeficiente indica el número total de moléculas.</li>
                    </label>
                    <br>
                    ...
                    <ul class="fables-main-text-color  font-14 my-3">
                        ...
                        <li type="square">GUÍA DE PRÁCTICA 15 - MOLÉCULAS: Construir una molécula</li>
                    ...
                    <ol class="fables-main-text-color  font-14 my-3">
                        <dl>
                            <dt><li>Seleccionar Hacer moléculas, y proceder de la siguiente manera:</li>
                            </dt>
                            <ul>
                                <dd><li type="circle">Arrastrar los elementos que se encuentran en los recipientes y formar diferentes moléculas.</li></dd>
                                <dd><li type="circle">Arrastrar las moléculas hacia la parte derecha de la simulación (de acuerdo a la molécula formada).</li></dd>
                                <dd><li type="circle">Visualizar los diferentes tipos de moléculas en 3D</li></dd>
                           
                            </ul>

                        </dl>
                        <dl>
                            <dt><li>Seleccionar Múltiple colección, proceder como en el paso 1, teniendo en cuanta que esta vez se deben formar 2 moléculas de cada tipo</li></dt>
                            <dt><li>Seleccionar "Moléculas más grandes", formar diferentes tipos de moléculas.</li></dt>
                    ...
                    <ol class="fables-main-text-color  font-14 my-3" >
                        <li>
                            El primer paso para construir una molécula es escribir la fórmula estructural.
                        </li>
                        <li>
                            La mayor parte de la materia está compuesta por moléculas o iones formados por átomos.
                        </li>
                        <li>
                           Las moléculas son agrupaciones estables de átomos unidos por un tipo de enlace químico que se denomina enlace covalente.
                        </li>
