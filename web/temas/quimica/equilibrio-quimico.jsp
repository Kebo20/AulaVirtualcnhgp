...
<html lang="en">
    ...
    <body>
        ...
        <div class="fables-footer-image fables-after-overlay white-color py-4 py-lg-5 bg-rules" style="background-image: url(../../imagenes/fondo-ciencias.jpg);">
            <div class="container">
                <h2 class="fables-page-title fables-second-border-color">GUÍA DE PRÁCTICA 18 - EQUILIBRIO QUÍMICO: Sales & Solubilidad</h2>
            </div>
        </div>
        <!-- /End Header -->
            ...
            <div class="container">
                <nav aria-label="breadcrumb">
                    <ol class="fables-breadcrumb breadcrumb px-0 py-3">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">EQUILIBRIO QUÍMICO: Sales y Solubilidad</li>
                    </ol>
            ...
            <div class="col-12 col-lg-10 offset-lg-1 col-xl-8 offset-xl-2 mt-4 mt-xl-5" >
                ...
                <div class="col-12 col-lg-8">   
                    ...
                    <label class="fables-main-text-color fables-single-blog font-14 my-3" >
                        ...
                        <li>Clasificar la solubilidad de las diferentes sales.</li> 
                        <li>Determinar la proporción de aniones y cationes que crean un compuesto neutro.</li> 
                        <li>Calcular la molaridad de las soluciones saturadas, y los valores de Ksp.</li>
                    ...
                    <ul class="fables-main-text-color  font-14 my-3">
                        ...
                        <li type="square">GUÍA DE PRÁCTICA 18 - EQUILIBRIO QUÍMICO: Sales & Solubilidad</li>
                    ...
                    <ol class="fables-main-text-color  font-14 my-3">
                        <dl>
                            <dt><li>Seleccionar Sal de mesa, y proseguir de la siguiente manera:</li></dt>

                            <dd>Desplaza de arriba a abajo el depósito gris para vaciar la sal de mesa.</dd>
                            <dd>Observa el estado de los iones en la tabla derecha de la simulación.</dd>
                            <dd>Añade agua y observa como no cambia el estado de los iones</dd>
                            <dd>Retira solución y observa cómo cambia el estado de los iones.</dd>

                        </dl>

                        <dl>
                            <dt>
                            <li>Selecciona sales poco solubres, y procede como en el paso 1.</li>
                            </dt>
                        </dl>
                    ...
                    <ol class="fables-main-text-color  font-14 my-3" >
                        <li>
                            Las estructuras cristalinas varían y los tamaños de iones varían para ayudar a construir el concepto de que existen variaciones en el mundo natural. 
                        </li>
                        <li>
                            El volumen es mucho más pequeño en la pestaña ?Sal de mesa? porque es mucho más soluble.
                        </li>
                    ...
                    <p class="fables-main-text-color  font-14 my-3" >
                        De cualquier modo, la relación entre los dos tipos de energía determina que un compuesto sea más o menos soluble. La solubilidad es la capacidad que tiene una sustancia de disolverse otra; esto depende de los siguientes factores: La naturaleza o propiedades del soluto y del solvente, la temperatura, la presión y el pH.
                    </p>
                    <p class="fables-main-text-color  font-14 my-3">
                        La expresión que representa el constante de equilibrio para un electrolito sólido en equilibrio con sus iones en solución se llama producto de solubilidad (Kps).
                    </p>
                    ...
                    <p class="fables-main-text-color  font-14 my-3" >
                    Barreto, P. (2011). Análisis químico: un enfoque ambiental. Recuperado de https://unac.edu.pe/documentos/organizacion/vri/cdcitra/Informes_Finales_Investigacion/Julio_2011/IF_BARRETO_PIO_FIARN/CAP.%20V.PDF    
                    ...
                    <div style="position: relative; width: 300px; height: 197px;">
                        <a href="../../../archivos-aulavirtual/temas/quimica/soluble-salts_es_PE.jar" >
                            <img src="g18simulador.JPG"   width="300px" height="180px"/>
