...
<html lang="en">
    ...
    <body>
        ...
        <div class="fables-footer-image fables-after-overlay white-color py-4 py-lg-5 bg-rules" style="background-image: url(../../imagenes/fondo-ciencias.jpg);">
            <div class="container">
                <h2 class="fables-page-title fables-second-border-color">GUÍA DE PRÁCTICA - Trabajo de energía II: Ley Hooke</h2>
            </div>
        </div>    
        <!-- /End Header -->
            ...
            <div class="container">
                <nav aria-label="breadcrumb">
                    <ol class="fables-breadcrumb breadcrumb px-0 py-3">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Trabajo de energía II: Ley Hooke</li>
                    </ol>
        ...
        <div class="container">
            ...
            <div  align="center">
                ...
                <br>
                <a href="../../../archivos-aulavirtual/temas/fisica/TRABAJO DE ENERGIA (II).pdf" ><img src="../../imagenes/pdf.jpg"  width="250px" height="240px"></a>
            </div>
            ...
            <div class="col-12 col-lg-10 offset-lg-1 col-xl-8 offset-xl-2 mt-4 mt-xl-5" >
                ...
                <div class="col-12 col-lg-8">   
                    ...
                    <ul class="fables-main-text-color fables-single-blog font-14 my-3">
                        ...
                        <li type="disc">Explicar las relaciones entre fuerza aplicada, la fuerza del resorte, constante del resorte, el desplazamiento y la energía potencial.</li> 
                        <li type="disc">Describir cómo al conectar dos resortes en serie o en paralelo afecta la constante elástica efectiva y las fuerzas de resorte.</li> 
                        <li type="disc">Predecir cómo el potencial de energía almacenada en el resorte cambia como la constante de resorte y el cambio de desplazamiento.</li> 
                    ...
                    <ul class="fables-main-text-color  font-14 my-3">
                        ...
                        <li type="square">GUÍA DE PRÁCTICA - Trabajo de energía II: Ley Hooke</li>
                        <li type="square">PhET Interactive Simulation, Simulation physical, Hooke's Law</li>
                    ...
                    <ol class="fables-main-text-color  font-14 my-3">
                        ...
                        <li>Ventana de Introducción
                            Explora las relaciones entre fuerza aplicada, fuerza restauradora, desplazamiento y equilibrio.
                        </li>
                        <img src="g6p1.jpg">
                        <br>
                        <br>
                        <li>
                            Ventana de Sistemas
                            Investiga cómo la fuerza aplicada, la fuerza restauradora y la constante efectiva del resorte cambian cuando dos resortes están conectados en serie o en paralelo.
                        ...
                        <li>
                            Ventana de Energía
                            Explora cómo la fuerza aplicada, el desplazamiento y la constante del resorte afectan la energía potencial almacenada en el resorte.
                    ...
                    <label class="fables-main-text-color  font-14 my-3" >
                        <li>Las deformaciones sufridas por un resorte y el periodo de oscilación del mismo son proporcionales a la masa.</li>
                        <li>A medida que se le aplica una fuerza mayor al resorte su elongación va a ser más notable.</li>
                    ...
                    Sanger, A. Las fuerzas y su medición: La Ley de Hooke. Recuperado de https://www.ib.edu.ar/images/beca_ib_alum_niv_medio/trabajos/mat_didact/mec/Sanger.pdf
                    </p>peth simu
                    <br>
                    ...
                    <div style="position: relative; width: 300px; height: 197px;">
                        <a href="../../../archivos-aulavirtual/temas/fisica/hookes-law_es_PE.html" style="text-decoration: none;">
                            <img src="g6simulador.JPG"  style="border: none;" width="300px" height="180px"/>
