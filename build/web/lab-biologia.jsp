...
<html lang="en">
    ...
    <body>
        ...
        <div class="fables-footer-image fables-after-overlay white-color py-4 py-lg-5 bg-rules" style="background-image: url(imagenes/fondo-ciencias.jpg);">
            <div class="container">
                <h2 class="fables-page-title fables-second-border-color">LABORATORIO VIRTUAL DE BIOLOGÍA</h2>
            </div>
        </div>
        <!-- /End Header -->
            ...
            <div class="container">
                <nav aria-label="breadcrumb">
                    <ol class="fables-breadcrumb breadcrumb px-0 py-3">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Laboratorio virtual de biología</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="container ">
            <div class="form-group fables-subscribe-formgroup ">
                <input type="text" id="temaB" class="form-control fables-subscribe-input fables-btn-rouned fables-main-background-color"
        ...
        <div class="container">
            ...
            <div class="gallery-filter">
                ...
                <div class="portfolioContainer mt-4 my-lg-5 row" id="busqueda">
                    ...
                    <%for (Tema t : TemaDAO.ListarTema("B")) {%>
            ...
            <div class="row">
                ...
                <%for (Curso c: CursoDAO.listarCursoBiologia()) { %>
