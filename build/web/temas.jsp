...
<html lang="en">
    ...
    <body>
        ...
        <div class="fables-footer-image fables-after-overlay white-color py-4 py-lg-5 bg-rules" style="background-image: url(imagenes/fondo-ciencias.jpg);">
            <div class="container">
                <h2 class="fables-page-title fables-second-border-color">AGENTES FÍSICOS: Escala de pH</h2>
            </div>
        </div>
        <!-- /End Header -->
            ...
            <div class="col-12 col-lg-10 offset-lg-1 col-xl-8 offset-xl-2 mt-4 mt-xl-5" >
                ...
                <div class="col-12 col-lg-8">   
                    ...
                    <label class="fables-main-text-color fables-single-blog font-14 my-3" >
                        ...
                        <li>Determinar si un líquido es ácido, básico o neutro.</li> 
                        <li>Localizar ácidos o bases en orden relativo.</li> 
                        <li>Describir en una escala molecular, con ilustraciones, cómo el equilibrio del agua varía con el pH. </li> 
                    ...
                    <label class="fables-main-text-color  font-14 my-3">
                        ...
                        <br>
                        <li>Macro (apunta a conceptos cualitativos sobre el pH de los ácidos y bases cotidianos, incluida la dilución)</li> 
                        <li>  Micro (relaciona el pH con las concentraciones de iones H3O+ y OH-).</li> 


                    </label>
                    <div align="center">
                        <img src="imagenes/1año.jpg" width="120px" height="120px" >
                    </div>
                    ...
                    <label class="fables-main-text-color  font-14 my-3">
                        ...
                        <li>Mi solución (permite manipular directamente el pH o la concentración de iones, en lugar de agregar soluciones o agua al vaso de precipitados).</li> 
                    ...
                    <p class="fables-main-text-color  font-14 my-3" >La simulación no tiene en cuenta las diferentes constantes de disociación de ácido (Ka) para cada líquido en el cálculo de las concentraciones de iones o el pH después de la dilución. Hacemos la simplificación que cualquier aumento en la concentración del ion principal se debe a los iones ya presentes en el agua añadida. Por ejemplo, si los estudiantes añadir 100 ml de agua a una solución ácida, entonces el número de moles de H3O + aumenta por 1 x 10-8 mol. La concentración del ion de menor importancia se calcula entonces utilizando la constante de auto-ionización para el agua (Kw). Estos cálculos representan el efecto de nivelación de agua.</p>
                    <br>
                    ...
                    <div style="position: relative; width: 300px; height: 197px;">
                        <a href="imagenes/1.jar" style="text-decoration: none;">
                            <img src="https://phet.colorado.edu/sims/circuit-construction-kit/circuit-construction-kit-ac-virtual-lab-600.png" alt="Equipo de Construcción de Circuitos (AC+DC), Laboratorio Virtual" style="border: none;" width="300" height="197"/>
