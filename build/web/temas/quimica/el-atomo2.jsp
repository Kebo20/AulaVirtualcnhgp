...
<html lang="en">
    ...
    <body>
        ...
        <div class="fables-footer-image fables-after-overlay white-color py-4 py-lg-5 bg-rules" style="background-image: url(../../imagenes/fondo-ciencias.jpg);">
            <div class="container">
                <h2 class="fables-page-title fables-second-border-color">GUÍA DE PRÁCTICA 07 - EL ÁTOMO: Interacciones atómicas</h2>
            </div>
        </div>
        <!-- /End Header -->
            ...
            <div class="container">
                <nav aria-label="breadcrumb">
                    <ol class="fables-breadcrumb breadcrumb px-0 py-3">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">EL ÁTOMO: Interacciones atómicas</li>
                    </ol>
            ...
            <div class="col-12 col-lg-10 offset-lg-1 col-xl-8 offset-xl-2 mt-4 mt-xl-5" >
                ...
                <div class="col-12 col-lg-8">   
                    ...
                    <label class="fables-main-text-color  font-14 my-3" >
                        ...
                        <li>Explicar cómo las fuerzas atractiva y repulsiva gobiernan las interacciones entre átomos.</li> 
                        <li>Describir el efecto del potencial de la profundidad del pozo sobre las interacciones atómicas.</li> 
                        <li>Describir enlaces como dinámicos y longitudes de enlaces como distancias medias.</li> 
                    ...
                    <ul class="fables-main-text-color  font-14 my-3">
                        ...
                        <li type="square">GUÍA DE PRÁCTICA 07 - EL ÁTOMO: Interacciones atómicas</li> 
                        <li type="square">PhET Interactive Simulation, Simulation chemical,atomic interactions. </li> 
                    ...
                    <ol class="fables-main-text-color  font-14 my-3">
                        ...
                        <li>Escoger un par de átomos presentados (Neón-Neón, Argón-Argón, Oxígeno-Oxígeno, Neón-Argón, Neón-Oxígeno, Argón-Oxígeno) o atracción ajustable (ajustar parámetros directamente de la curva).</li>
                        <li>Arrastrar el átomo no fijado o el punto en el gráfico.</li>
                        <li>Ocultar o mostrar fuerzas entre átomos.</li>
                        <li>Interpretar</li>
                    ...
                    <ol class="fables-main-text-color  font-14 my-3" >
                        <li>La interacción entre los dos átomos se modela utilizando el potencial de Lennard-Jones.</li>
                        <li>Al seleccionar pares de átomos, la selección oxígeno-oxígeno es la única en la que los átomos se unen. Cuando se forma el enlace, el temblor del átomo izquierdo está destinado a representar la energía transferida lejos del par unido.</li>
                        <li>Para la interacción de enlace oxígeno-oxígeno, épsilon  corresponde aproximadamente a la energía de enlace promedio. Sigma  se calculó en función de la longitud de enlace promedio, ya que el fondo del pozo de energía potencial se ubica a la distancia de enlace de equilibrio.</li>
                    ...
                    <p class="fables-main-text-color  font-14 my-3" >
                        Al inicio, cuando dos átomos están alejados lo suficiente, no hay interacción. Se dice que la energía potencial de este sistema es cero. Conforme los átomos se aproximan uno al otro, cada electrón es atraído por el núcleo del otro átomo; al mismo tiempo, los electrones se repelen entre sí, y también los dos núcleos. Mientras los átomos todavía están separados, la atracción es mayor que la repulsión, por lo que la energía potencial del sistema disminuye, es decir se vuelve negativa, a medida que los átomos se acercan.
                    </p>
                    <p class="fables-main-text-color  font-14 my-3" >
                        Esta tendencia continúa hasta que la energía potencial alcanza un valor mínimo. En este punto, cuando el sistema tiene la energía potencial mínima, es más estable.
                    </p>
                    <p class="fables-main-text-color  font-14 my-3">
                        Si la distancia entre los núcleos disminuyera aún más, la energía potencial aumentaría rápido y finalmente sería positiva como resultado del aumento de las repulsiones electrón-electrón y núcleo-núcleo.
                    </p>
                    <br>
                    ...
                    <div style="position: relative; width: 300px; height: 197px;">
                        <a href="../../../archivos-aulavirtual/temas/quimica/atomic-interactions_es_PE.html" >
                            <img src="g7simulador.JPG"   width="300px" height="180px"/>
