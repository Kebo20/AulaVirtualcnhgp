...
<html lang="en">
    ...
    <body>
        ...
        <div class="fables-footer-image fables-after-overlay white-color py-4 py-lg-5 bg-rules" style="background-image: url(../../imagenes/fondo-ciencias.jpg);">
            <div class="container">
                <h2 class="fables-page-title fables-second-border-color">GUÍA DE PRÁCTICA 05 - LA MATERIA: Estados de la materia</h2>
            </div>
        </div>
        <!-- /End Header -->
            ...
            <div class="col-12 col-lg-10 offset-lg-1 col-xl-8 offset-xl-2 mt-4 mt-xl-5" >
                ...
                <div class="col-12 col-lg-8">   
                    ...
                    <ul class="fables-main-text-color  font-14 my-3">
                        ...
                        <li type="square">GUÍA DE PRÁCTICA 05 - LA MATERIA: Estados de la materia</li> 
                    ...
                    <ol class="fables-main-text-color  font-14 my-3">
                        ...
                        <br>
                        *   Escoger un átomo o molécula.
                        <br>
                        *   Elegir y probar los tres estados de la materia: sólido, líquido o gaseoso.
                        <br>
                        *   Añadir o quitar calor al sistema. 
                        <br>
                        *   Observar e interpretar el movimiento de la muestra. 
                        ...
                        <br>
                        *   Comprimir la muestra, desplazando la tapa hacía abajo. 
                         <br>
                        *   Bombear átomos o moléculas adicionales.
                         <br>
                        *   Añadir o quitar calor al sistema. 
                        <br>
                        <br>
                        <li> Seleccionar “interacción”, y proceder de la siguiente manera:</li>
                        <br>
                        *   Escoger uno de los átomos presentados (Neón, Argón) o atracción ajustable (ajustar parámetros directamente de la curva).
                         <br>
                        *   Arrastrar el átomo no fijado o el punto en el gráfico
                         <br>
                        *   Ocultar o mostrar fuerzas entre átomos.
                    ...
                    <p class="fables-main-text-color  font-14 my-3" >
                        ...
                        La temperatura del sistema se calcula a partir de las velocidades de las partículas, y puede cambiar a medida que más partículas son bombeados en el sistema.
                        <br>
                        La presión en el sistema se deriva de las transferencias de impulso entre las partículas y las paredes del recipiente.
