...
<html lang="en">
    ...
    <body>
        ...
        <div class="fables-footer-image fables-after-overlay white-color py-4 py-lg-5 bg-rules" style="background-image: url(../../imagenes/fondo-ciencias.jpg);">
            <div class="container">
                <h2 class="fables-page-title fables-second-border-color">GUÍA DE PRÁCTICA 10 - CONCENTRACIÓN MOLAR: Molaridad</h2>
            </div>
        </div>
        <!-- /End Header -->
            ...
            <div class="container">
                <nav aria-label="breadcrumb">
                    <ol class="fables-breadcrumb breadcrumb px-0 py-3">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">CONCENTRACIÓN MOLAR: Molaridad</li>
                    </ol>
            ...
            <div class="col-12 col-lg-10 offset-lg-1 col-xl-8 offset-xl-2 mt-4 mt-xl-5" >
                ...
                <div class="col-12 col-lg-8">   
                    ...
                    <label class="fables-main-text-color fables-single-blog font-14 my-3" >
                        ...
                        <li>Describir las relaciones entre volumen y cantidad de soluto en una concentración</li> 
                        <li>Calcular la concentración de las soluciones en unidades de molaridad (mol / l).</li> 
                        <li>Utilizar la molaridad para calcular la dilución de las soluciones.</li>
                    </label>
                    <br>
                    ...
                    <ul class="fables-main-text-color  font-14 my-3">
                        ...
                        <li type="square">GUÍA DE PRÁCTICA 10 - CONCENTRACIÓN MOLAR: Molaridad</li>
                        <li type="square">PhET Interactive Simulation, Simulation chemical, Molarity.</li>
                    ...
                    <ol class="fables-main-text-color  font-14 my-3">
                        Explorar cualitativa y cuantitativamente las relaciones entre cantidad de soluto, el volumen de la solución, y la concentración de la solución, de la siguiente manera:                         <br><br>

                        <li>Escoger y experimentar con los diferentes solutos presentados.</li>
                        <li>Incrementar o disminuir el volumen de solución.</li>
                        <li>Añadir o eliminar soluto.</li>
                        <li>Observar e interpretar la concentración de la solución (Molaridad).</li>
                    ...
                    <label class="fables-main-text-color  font-14 my-3" >
                        <li>La molaridad solo se refiere a la cantidad de soluto originalmente disuelto en agua y no toma en cuenta los procesos subsecuentes, como la disolución de una sal o la ionización de un ácido.</li>
                        <li>El volumen de la solución es el volumen combinado de soluto y agua.</li>
                        <li>No tadas las soluciones llegan a la saturación, por el que el número de moles que puede añadirse es limitada a la gama de 0.2-1.0 moles.</li>
                    ...
                    <p class="fables-main-text-color  font-14 my-3" >
                        La molaridad es la unidad de concentración química que relaciona la medida de la cantidad de masa de soluto con la medida del volumen de disolución acuosa. Se representa por M y se define como la cantidad de moles de soluto disueltos en 1 litro de disolución, según la siguiente expresión: 
                        <br>
                        M=Moles de sto/(Litros de soln)
                        <br>
                        En donde soln significa disolución.
                    ...
                    <div style="position: relative; width: 300px; height: 197px;">
                        <a href="../../../archivos-aulavirtual/temas/quimica/molarity_es_PE.html" >
                            <img src="g10simulador.JPG"   width="300px" height="180px"/>
