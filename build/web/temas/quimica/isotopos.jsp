...
<html lang="en">
    ...
    <body>
        ...
        <div class="fables-footer-image fables-after-overlay white-color py-4 py-lg-5 bg-rules" style="background-image: url(../../imagenes/fondo-ciencias.jpg);">
            <div class="container">
                <h2 class="fables-page-title fables-second-border-color">GUÍA DE PRÁCTICA 08 - ISÓTOPOS: Isótopos y masa atómica</h2>
            </div>
        </div>
        <!-- /End Header -->
            ...
            <div class="container">
                <nav aria-label="breadcrumb">
                    <ol class="fables-breadcrumb breadcrumb px-0 py-3">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Isótopos y masa atómica</li>
                    </ol>
            ...
            <div class="col-12 col-lg-10 offset-lg-1 col-xl-8 offset-xl-2 mt-4 mt-xl-5" >
                ...
                <div class="col-12 col-lg-8">   
                    ...
                    <label class="fables-main-text-color  font-14 my-3" >
                        ...
                        <li>Definir isótopo utilizando el número de masa, número atómico, el número de protones, neutrones y electrones.</li> 
                        <li>Teniendo en cuenta la información sobre un elemento, calcular la masa y el nombre de un isótopo.</li> 
                        <li>Calcula la masa atómica promedio de un elemento debido a la abundancia y la masa de sus isótopos.</li> 
                    ...
                    <ul class="fables-main-text-color  font-14 my-3">
                        ...
                        <li type="square">GUÍA DE PRÁCTICA 08 - ISÓTOPOS: Isótopos y masa atómica</li> 
                        <li type="square">PhET Interactive Simulation, Simulation chemical,Isotopes and atomic mass.</li> 
                    ...
                    <ol class="fables-main-text-color  font-14 my-3">
                        <dl>
                            <dt><li>Seleccionar Isótopos, construirlos e investigar la masa atómica, número de masa, y la abundancia relativa del mismo, de la siguiente manera: </li>
                            </dt>
                            <ul>
                                <dd><li type="circle">Añadir neutrones para crear un nuevo isótopo o elegir un elemento de la tabla periódica para investigar.</li></dd>
                                <dd><li type="circle">Observar el número atómico para el isótopo</li></dd>
                                <dd><li type="circle">Observar la abundancia del isótopo (porcentaje).</li></dd>
                            </ul>

                        </dl>
                        <dl>
                            <dt><li>Seleccionar Mezclas, crear mezclas de isótopos, investigar cómo se calcula la masa atómica promedio, y comparar sus mezclas con una vista de una mezcla real de isótopos. </li>
                            </dt>
                            <ul>
                                <dd><li type="circle">Arrastrar los átomos de los cubos para hacer una mezcla.</li></dd>
                                <dd><li type="circle">Observar el porcentaje de composición y la masa atómica promedio de la mezcla creada e interpretar</li></dd>
                    ...
                    <ol class="fables-main-text-color  font-14 my-3" >
                        <li>La masa atómica de la simulación, se muestra sólo para isótopos estables.</li>
                        <li>El núcleo del isótopo más común del átomo de hidrógeno (también el átomo estable más simple posible) está formado por un único protón.</li>
                        <li>La masa atómica de un elemento no coincide con su número másico.</li>

                    </ol>
                    <br>
                    <h2 class="font-20 semi-font my-3 fables-second-text-color fables-second-hover-color">Fundamentos</h2>
                    <p class="fables-main-text-color  font-14 my-3" >
                        La masa de un átomo depende del número que contiene de electrones, protones y neutrones. Los átomos son partículas extremadamente pequeñas, incluso la partícula más pequeña de polvo que puede apreciarse a simple vista contiene 1x1016 átomos. 

                    </p>
                    <p class="fables-main-text-color  font-14 my-3" >
                        No es posible pesar un solo átomo, pero existen métodos experimentales para determinar su masa en relación con la de otro. Uno de ellos consiste en asignar un valor a la masa de un átomo de un elemento determinado para utilizarlo como referencia.

                    </p>
                    <p class="fables-main-text-color  font-14 my-3" >
                        Según acuerdos internacionales, la masa atómica, es la masa de un átomo, en unidades de masa atómica (uma). Una unidad de masa atómica se define como una masa exactamente igual a un doceavo de la masa de un átomo de carbono 12. El carbono 12 es el isótopo del carbono que tiene seis protones y seis neutrones. Al fijar la masa del carbono 12 como 12 uma se tiene el átomo que se utiliza como referencia para medir la masa atómica de los demás elementos. 
                    ...
                    <div style="position: relative; width: 300px; height: 197px;">
                        <a href="../../../archivos-aulavirtual/temas/quimica/isotopes-and-atomic-mass_es_PE.html" >
                            <img src="g8simulador.JPG"   width="300px" height="180px"/>
