...
<html lang="en">
    ...
    <body>
        ...
        <div class="fables-footer-image fables-after-overlay white-color py-4 py-lg-5 bg-rules" style="background-image: url(../../imagenes/fondo-ciencias.jpg);">
            <div class="container">
                <h2 class="fables-page-title fables-second-border-color">GUÍA DE PRÁCTICA 12 - ENERGÍA CELULAR: Motores moleculares</h2>
            </div>
        </div>
        <!-- /End Header -->
            ...
            <div class="container">
                <nav aria-label="breadcrumb">
                    <ol class="fables-breadcrumb breadcrumb px-0 py-3">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">ENERGÍA CELULAR: Motores moleculares</li>
                    </ol>
            ...
            <div class="col-12 col-lg-10 offset-lg-1 col-xl-8 offset-xl-2 mt-4 mt-xl-5" >
                ...
                <div class="col-12 col-lg-8">   
                    ...
                    <ul class="fables-main-text-color  font-14 my-3" >
                        ...
                        <li type="square">Descubrir lo que controla la velocidad de diminutos motores moleculares en nuestro cuerpo a través de un tirón a una única hebra de ADN.</li> 
                    ...
                    <ul class="fables-main-text-color  font-14 my-3">
                        ...
                        <li type="square">Guía de práctica 12- Energía celular: motores moleculares. </li> 
                    ...
                    <p class="fables-main-text-color  font-14 my-3">
                        ...
                        1)	Mover la pinza óptica para estirar el ADN.
                        <br>
                        2)	Aumentar o disminuir la potencia.
                        <br>
                        3)	Marcar las opciones tanto de motor molecular  (enzima), fuerzas sobre la burbuja o gráficos para mostrar con más detalle el proceso
                    ...
                    <ul class="fables-main-text-color  font-14 my-3" >
                        ...
                        <li type="square">Los motores convierten energía en movimiento sin embargo los motores moleculares hacen exactamente lo mismo, pero a una escala microscópica. </li>                  

                        <li type="square">La respiración celular sería imposible de llevar a cabo sin un motor molecular llamado ATP-sintasa. Muchas bacterias (y los espermatozoides) serían incapaces de moverse por ahí si no fuera por los motores moleculares.</li>
                    </ul>
                    <br>
                    <h2 class="font-20 semi-font my-3 fables-second-text-color fables-second-hover-color">Fundamentos</h2>
                    <p class="fables-main-text-color  font-14 my-3" >
                        Un sistema de transporte está constituido por vehículos y caminos. Los que actúan como vehículos en la célula son proteínas especializadas, llamadas motores moleculares, que se clasifican en diferentes tipos o familias de acuerdo con su estructura y su función.
                        Un motor molecular es del orden de unos pocos nanómetros y está compuesto de unas pocas decenas de miles de átomos. Como consecuencia, está sometido a fluctuaciones de energía enormes que lo obligan a describir caminos aleatorios.
