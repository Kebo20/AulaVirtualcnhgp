...
<html lang="en">
    ...
    <body>
        ...
        <div class="fables-footer-image fables-after-overlay white-color py-4 py-lg-5 bg-rules" style="background-image: url(../../imagenes/fondo-ciencias.jpg);">
            <div class="container">
                <h2 class="fables-page-title fables-second-border-color">VISIÓN HUMANA: Visión de color</h2>
            </div>
        </div>
        <!-- /End Header -->
            ...
            <div class="container">
                <nav aria-label="breadcrumb">
                    <ol class="fables-breadcrumb breadcrumb px-0 py-3">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">GUÍA DE PRÁCTICA 05 - VISIÓN HUMANA: Visión de color</li>
                    </ol>
            ...
            <div class="col-12 col-lg-10 offset-lg-1 col-xl-8 offset-xl-2 mt-4 mt-xl-5" >
                ...
                <div class="col-12 col-lg-8">   
                    ...
                    <ul class="fables-main-text-color fables-single-blog font-14 my-3" >
                        ...
                        <li type="disc">Determinar qué color la persona ve para diversas combinaciones de rojo, verde y azul</li> 
                        <li type="disc">Describir el color de la luz que es capaz de pasar a través de filtros de diferentes colores</li> 
                    ...
                    <ul class="fables-main-text-color  font-14 my-3">
                        ...
                        <li type="square">Guía de práctica 05- Visión humana: visión de color.</li> 
                        <li type="square">PhET Interactive Simulation, Simulation biology, color visión.</li> 
                    ...
                    <p class="fables-main-text-color  font-14 my-3">
                        ...
                        <br>
                        1)	Investigar la percepción del color y la sustracción de color.
                    ...
                    <p class="fables-main-text-color  font-14 my-3">
                        2) Explorar adición de color con la luz roja, verde y azul.                    
                    </p>
                    <div align="center">
                    ...
                    <ul class="fables-main-text-color  font-14 my-3" >
                        ...
                        <li type="disc">Cada fotón de píxeles representa muchos fotones en el modelo. A veces, el color aún se puede percibir incluso cuando un fotón de píxeles no golpea con precisión el ojo porque el modelo subyacente supone que hay un haz de fotones presente.</li>
                        <li type="disc">La fuente de luz en la pantalla de una sola bombilla se modela como un láser sintonizable, y los filtros se modelan como filtros ópticos de paso de banda. El objetivo de estos filtros es darse cuenta que un filtro es sustractivo, no aditivo.</li>
                    </ul>
                    <br>
                    <h2 class="font-20 semi-font my-3 fables-second-text-color fables-second-hover-color">Fundamentos</h2>
                    <p class="fables-main-text-color  font-14 my-3" >
                        Cada bastón de nuestra retina contiene un pigmento que absorbe algunas longitudes de onda mejor que otras. Los pigmentos, si fuéramos capaces de obtener suficiente cantidad de ellos como para verlos, serían coloreados. 
                        Un pigmento visual tiene la propiedad especial de que cuando absorbe un fotón de luz, cambia su configuración molecular y al mismo tiempo libera energía.
                        La liberación ocasiona una cadena de eventos químicos en la célula, que dan lugar a una señal eléctrica y liberación de un transmisor químico en la sinapsis.

                    </p>
                    <br>
                    <h2 class="font-20 semi-font my-3 fables-second-text-color fables-second-hover-color">REFERENCIAS BIBLIOGRÁFICAS</h2>
                    <p class="fables-main-text-color  font-14 my-3" >
                        Hubel, D. (2000). Ojo, cerebro y visión. Recuperado de https://books.google.com.pe/books?id=Sjg5alekuXwC&pg=PA159&dq=Vision+a+color&hl=es-419&sa=X&ved=0ahUKEwij6NCMvIblAhXR1VkKHem-AQEQ6AEIMzAB#v=onepage&q=Vision%20a%20color&f=false                    <br>
