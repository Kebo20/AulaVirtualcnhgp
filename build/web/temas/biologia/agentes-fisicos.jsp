...
<html lang="en">
    ...
    <body>
        ...
        <div class="fables-footer-image fables-after-overlay white-color py-4 py-lg-5 bg-rules" style="background-image: url(../../imagenes/fondo-ciencias.jpg);">
            <div class="container">
                <h2 class="fables-page-title fables-second-border-color">GUÍA DE PRÁCTICA 01 - Agentes físicos : escala de ph</h2>
            </div>
        </div>
        <!-- /End Header -->
            ...
            <div class="container">
                <nav aria-label="breadcrumb">
                    <ol class="fables-breadcrumb breadcrumb px-0 py-3">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Agentes físicos : escala de ph</li>
                    </ol>
            ...
            <div class="col-12 col-lg-10 offset-lg-1 col-xl-8 offset-xl-2 mt-4 mt-xl-5" >
                ...
                <div class="col-12 col-lg-8">   
                    ...
                    <ul class="fables-main-text-color  font-14 my-3" >
                        ...
                        <li type="disc">Determinar si un líquido es ácido, básico o neutro.</li> 
                        <li type="disc">Localizar ácidos o bases en orden relativo.</li> 
                        <li type="disc">Describir en una escala molecular, con ilustraciones, cómo el equilibrio del agua varía con el pH. </li> 
                    ...
                    <ul class="fables-main-text-color  font-14 my-3">
                        ...
                        <li type="square">Guía de práctica  01 - Agentes físicos: Escala de pH</li> 
                        <li type="square">PhET Interactive Simulation, Simulation biology, pH scale</li> 
                    ...
                    <ul class="fables-main-text-color  font-14 my-3">
                        ...
                        <br>
                        <li type="disc">Macro (apunta a conceptos cualitativos sobre el pH de los ácidos y bases cotidianos, incluida la dilución)</li> 
                        <li type="disc">  Micro (relaciona el pH con las concentraciones de iones H3O+ y OH-).</li> 


                    </ul>
                    <div align="center">
                        <img src="g1p1.jpg" width="500px" height="300px" >
                    </div>
                    ...
                    <ul class="fables-main-text-color  font-14 my-3">
                        ...
                        <li type="disc">Mi solución (permite manipular directamente el pH o la concentración de iones, en lugar de agregar soluciones o agua al vaso de precipitados).</li> 


                    </ul>
                    <div align="center">
                        <img src="g1p2.jpg" width="500px" height="300px" >
                    </div>
                    <br>
                    <h2 class="font-20 semi-font my-3 fables-second-text-color fables-second-hover-color">Conclusiones</h2>
                    <p class="fables-main-text-color  font-14 my-3" >
                       	Debido a que la relación de iones H3O+/OH se muestra con puntos, estos se pueden confundir inicialmente con el número real de iones en el vaso de precipitados.
                        Además, dado que la relación de iones se aproxima a una relación lineal en la mayoría de los valores de pH, las diferencias tras la dilución o pequeños cambios en el pH son difíciles de ver. Por ello se debe comparar la relación a través de diferencias más grandes en el pH. 
                    </p>
                    <br>
                    <h2 class="font-20 semi-font my-3 fables-second-text-color fables-second-hover-color">Fundamentos</h2>
                    <p class="fables-main-text-color  font-14 my-3" >
                        La escala de pH expresa la concentración de iones hidrógeno en una solución empleando una escala de 0 (muy ácida) a 14 (muy básica). Cada unidad de cambio en el pH dentro de la escala representa un cambio de diez veces en la concentración de iones de hidrógeno. El agua pura, con concentraciones iguales de H+ y OH-, tienen un pH de 7. 
                        Las sustancias ácidas, como el jugo de limón y el vinagre, tienen un sabor agrio. Ello se debe a que los receptores de sabor agrio de la lengua se han especializado para responder al exceso de H+.

                    </p>
                    <br>
                    <h2 class="font-20 semi-font my-3 fables-second-text-color fables-second-hover-color">REFERENCIAS BIBLIOGRÁFICAS</h2>
                    <p class="fables-main-text-color  font-14 my-3" >
                        Ausdesirk, G., Audesirk, G. y Byers, B. (2003). Biología: la vida en la tierra. Recuperado de  https://books.google.com.pe/books?id=uO48-6v7GcoC&printsec=frontcover&source=gbs_ge_summary_r&cad=0#v=onepage&q&f=false
                    ...
                    <div style="position: relative; width: 300px; height: 197px;">
                        <a href="../../../archivos-aulavirtual/temas/biologia/ph-scale-basics_es_PE.html" style="text-decoration: none;">
                            <img src="g1simulador.jpg"  style="border: none;" width="300px" height="180px"/>
