...
<html lang="en">
    ...
    <body>
        ...
        <div class="fables-footer-image fables-after-overlay white-color py-4 py-lg-5 bg-rules" style="background-image: url(../../imagenes/fondo-ciencias.jpg);">
            <div class="container">
                <h2 class="fables-page-title fables-second-border-color">GUÍA DE PRÁCTICA - ELECTROMAGNETISMO: Laboratorio Electromagnético de Faraday</h2>
            </div>
        </div>  
        <!-- /End Header -->
            ...
            <div class="container">
                <nav aria-label="breadcrumb">
                    <ol class="fables-breadcrumb breadcrumb px-0 py-3">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">ELECTROMAGNETISMO: Laboratorio Electromagnético de Faraday</li>
                    </ol>
            ...
            <div class="col-12 col-lg-10 offset-lg-1 col-xl-8 offset-xl-2 mt-4 mt-xl-5" >
                ...
                <div class="col-12 col-lg-8">   
                    ...
                    <ul class="fables-main-text-color  font-14 my-3">
                        ...
                        <li type="square">Predecir la dirección del campo magnético para diferentes lugares alrededor de un imán y un electroimán.</li> 
                        <li type="square">Compare y contraste las barras de imanes y electroimanes.</li> 
                        <li type="square">Identificar las características de los electroimanes que son variables y qué efectos tiene cada variable sobre la fuerza del campo magnético y dirección.</li> 
                        <li type="square">Relacionar la fuerza del campo magnético a la distancia cuantitativa y cualitativamente.</li> 
                        <li type="square">Identificar los equipos y las condiciones que producen la inducción.</li> 
                        <li type="square">Comparar y contrastar cómo una bombilla y un voltímetro pueden ser utilizados para mostrar las características de la corriente inducida.</li> 
                        <li type="square">Predecir cómo la corriente cambiará cuando las condiciones son variadas.</li> 
                    ...
                    <ul class="fables-main-text-color  font-14 my-3">
                        ...
                        <li type="square">GUÍA DE PRÁCTICA - ELECTROMAGNETISMO: Laboratorio Electromagnético de Faraday</li>
                    ...
                    <ol class="fables-main-text-color  font-14 my-3">
                        ...
                        <dl>
                            ...
                            <dt><li>Seleccionar, "Bobinado", y arrastrar  la barra magnética alrededor del bobinado o por dentro de ella y observar el cambio de voltaje producido.</li></dt>
                        ...
                        <dl>
                            ...
                            <dt><li>Seleccionar, "Transformador", y arrastrar, la fuente de corriente (DC), sobre el bobinado enérgicamente, cambiando el rango de voltaje de la pila. </li></dt>
                        ...
                        <dl>
                            ...
                            <dt><li>Seleccionar, "Generador", y abrir el grifo, nótese la intensidad de voltaje producido, así como también la dirección de la barra magnética.</li></dt>
                    ...
                    <label class="fables-main-text-color  font-14 my-3" >
                        <li>Para comprender la dirección del campo en el imán: la corriente eléctrica es la carga en movimiento. </li>
                        <li>Los campos magnéticos son creados por corrientes eléctricas.</li>
                        <li>El efecto neto de todas las corrientes microscópicas de electrones es hacer una corriente macroscópica que es exactamente como la corriente en un solenoide. Por lo tanto, un imán de barra como un solenoide de corriente en forma de barra.</li>
                    ...
                    <ol class="fables-main-text-color  font-14 my-3" >
                        <dl>
                            <dt><li>Faraday, observó la aparición de corrientes transitorias en circuitos en las tres situaciones siguientes: </li></dt>
